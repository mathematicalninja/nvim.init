...
local opts = {
    ...
    keymaps = {
        ...
        -- Open file, split/horiz/tab
        ["<CR>"] = "actions.select",
        ["<C-s>"] = { "actions.select", opts = { vertical = true } },
        ["<C-h>"] = { "actions.select", opts = { horizontal = true } }, -- This is the horizontal split
        ["<C-t>"] = { "actions.select", opts = { tab = true } },

        -- open "preview" i.e. non-focused version
        -- new preview hides old preview
        ["<C-p>"] = "actions.preview",
        ...
        ["gx"] = "actions.open_external", -- uses system default -- IDEA: change to <C-CR> allows opening pdfs etc.

        --system files
        ["g."] = { "actions.toggle_hidden", mode = "n" },

        -- accidental deletes go here
...
local oil = {
    ...
    dependencies = { { gh("echasnovski/mini.icons"), opts = {} } },
