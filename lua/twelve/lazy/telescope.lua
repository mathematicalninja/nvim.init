--TODO: make resume search enter in "n" mode
return { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>sp", function()
            builtin.find_files({
                cwd = join(vim.fn.stdpath("data"), "lazy"),
                prompt_title = "search lazy plugins",
            })
        end, { desc = "[s]earch lazy [p]lugins" })

        vim.keymap.set("n", "<leader>si", function()
            builtin.find_files({ cwd = join("~", ".config", ".notes") })
        end, { desc = "[s]earch [i]dea files" })
    end,
}
